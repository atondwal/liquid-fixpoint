...
module Language.Fixpoint.Solver.Solve (solve, runInterpolation, gradualSolve, solverInfo) where
...
---------------------------------------------------------------------------
runInterpolation :: Config -> SolverInfo a -> SolveM b -> IO b
---------------------------------------------------------------------------
runInterpolation cfg sI = runSolverM cfg sI 0 $ siSol sI
